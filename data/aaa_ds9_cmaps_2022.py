...
# from -- https://gist.github.com/adonath/c9a97d2f2d964ae7b9eb
...
register_cmap(cmap=LinearSegmentedColormap(name='ds9b',segmentdata=ds9b))
register_cmap(cmap=LinearSegmentedColormap(name='ds9cool',segmentdata=ds9cool))
register_cmap(cmap=LinearSegmentedColormap(name='ds9a',segmentdata=ds9a))
register_cmap(cmap=LinearSegmentedColormap(name='ds9i8',segmentdata=ds9i8))
register_cmap(cmap=LinearSegmentedColormap(name='ds9aips0',segmentdata=ds9aips0))
register_cmap(cmap=LinearSegmentedColormap(name='ds9rainbow',segmentdata=ds9rainbow))
register_cmap(cmap=LinearSegmentedColormap(name='ds9he',segmentdata=ds9he))
register_cmap(cmap=LinearSegmentedColormap(name='ds9heat',segmentdata=ds9heat))
